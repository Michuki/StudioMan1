...
public class WStudioManKafkaResourceIT {
    ...
    @Autowired
    private WStudioManKafkaProducer producer;

    @Autowired
    private WStudioManKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        WStudioManKafkaResource kafkaResource = new WStudioManKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/w-studio-man-kafka/publish?message=test"))
